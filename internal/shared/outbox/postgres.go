...
func (r *PostgresOutboxRepository) Create(ctx context.Context, tx pgx.Tx, o Outbox) error {
	const q = `
...
func (r *PostgresOutboxRepository) ListAndLock(ctx context.Context, tx pgx.Tx, limit, maxRetries int) ([]Outbox, error) {
	const q = `
